...
test_that("redcap_import_select works", {
  expect_error(redcap_import_select(importdemo_data, importdemo_dict, auto_skip_nomatch = TRUE,
                                    skip_intro = TRUE, suppress_txt = TRUE, log = FALSE, wait = 0), NA)
  x <- redcap_import_select(importdemo_data, importdemo_dict, auto_skip_nomatch = TRUE,
                            skip_intro = TRUE, suppress_txt = TRUE, log = FALSE, wait = 0)
